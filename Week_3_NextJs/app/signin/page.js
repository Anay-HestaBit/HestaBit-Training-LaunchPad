      ...
      <section className="flex items-center justify-center px-6">
        <div className="w-full max-w-sm">
          ...
          <form className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-gray-200 px-4 py-2 focus:border-teal-400 focus:outline-none"
              />
            </div>
          ...
          <p className="mt-4 text-center text-sm text-gray-500">
            ...
            <a href='/signup' className="cursor-pointer font-semibold text-teal-400">
              Sign up
            </a>
          </p>
        </div>
